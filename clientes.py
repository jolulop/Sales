...
def crear_tab_clientes(tab):
    ...
    button_frame_clientes = tk.Frame(tab)
    button_frame_clientes.pack(pady=20)

    tk.Button(button_frame_clientes, text="Agregar", command=lambda: add_cliente(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_var, estado_var, clasificacion_var, observaciones_entry)).grid(row=0, column=0)
    tk.Button(button_frame_clientes, text="Actualizar", command=lambda: update_cliente(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_var, estado_var, clasificacion_var, observaciones_entry)).grid(row=0, column=1)
    tk.Button(button_frame_clientes, text="Eliminar", command=delete_cliente).grid(row=0, column=2)
    tk.Button(button_frame_clientes, text="Limpiar", command=lambda: clear_fields(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_entry, estado_var, clasificacion_var)).grid(row=0, column=3)

    # Grid para mostrar los clientes
    global tree
    tree = ttk.Treeview(tab, columns=("id", "nombre", "ID_fiscal", "parent_id", "sector", "pais", "tamaño", "observaciones", "estado", "clasificacion"), show="headings")
...
def add_cliente(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_var, estado_var, clasificacion_var, observaciones_entry):
    if nombre_var.get() == "":
    ...
    clear_fields(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_entry, estado_var, clasificacion_var)
    fetch_clientes()

def update_cliente(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_var, estado_var, clasificacion_var, observaciones_entry):
...
def clear_fields(nombre_var, id_fiscal_var, parent_id_var, sector_var, pais_var, tamaño_var, observaciones_entry, estado_var, clasificacion_var):
    nombre_var.set("")
    id_fiscal_var.set("")
    parent_id_var.set("N/A")
    sector_var.set("")
